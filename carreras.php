...
<head>
    ...
    <title>Deal Broker - Carreras</title>
...
<body>
    ...
    <main class="main bggame">
        ...
        <section>
            <div class="container">
                <h1 class="h1 color_w">CARRERAS</h1>
                <h3 class="color_s">Grupo especializado y encargado del proyecto 'Deal Broker Gaming'.</h3><br><br>
                <aside class="column">
